...
The goal of tveTableTool is to provide flexible and powerful tools for creating cross-tabulation tables from survey data. It handles both labeled and unlabeled data, supports weighting, and provides various formatting options for analyzing and presenting survey results.
...
For data without variable labels, use the unlabeled version of the function:
